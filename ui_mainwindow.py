...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.action_dijkstra = QAction(MainWindow)
        self.action_dijkstra.setObjectName(u"action_dijkstra")
        ...
        self.menuAlgoritmos.addAction(self.action_dijkstra)
...
#endif // QT_CONFIG(shortcut)
        self.action_dijkstra.setText(QCoreApplication.translate("MainWindow", u"Dijkstra", None))
#if QT_CONFIG(shortcut)
        self.action_dijkstra.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+D", None))
#endif // QT_CONFIG(shortcut)
